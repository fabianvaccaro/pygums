...
#arr = mean_bilateral(arr.astype(np.uint16), disk(30), s0=20 , s1=20)
...
entro4=entropy(sample_patch, disk(12))
...
ax5.hist(entro4.ravel(), 256, histtype='step', color='black')
